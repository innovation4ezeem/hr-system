      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
          <div className="flex items-center justify-between">
            <Link href="/admin-panel/users" className="text-sm text-slate-400 hover:text-white flex items-center gap-2 transition-colors">
            ...
            <div className="flex bg-slate-900 p-1 rounded-xl border border-slate-800">
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs font-bold transition-all ${
                  currentView === 'profile' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                Profile & Security
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs font-bold transition-all ${
                  currentView === 'performance' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                Performance Scores
              </button>
